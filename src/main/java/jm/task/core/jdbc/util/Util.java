        ...
        if (sessionFactory == null) {
            try {
                ...
                Configuration configuration = new Configuration()
                        ...
                        .setProperty("hibernate.connection.driver_class", DRIVER) // Драйвер для MySQL
                        .setProperty("hibernate.connection.url", URL) // URL подключения к базе
                        .setProperty("hibernate.connection.username", USER) // Имя пользователя базы данных
                        .setProperty("hibernate.connection.password", PASSWORD) // Пароль для подключения
